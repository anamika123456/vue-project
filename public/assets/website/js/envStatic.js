module.exports = {
    ...
    withdrawalMethod: { 1: '"bank_transfer.svg"', 2: '"skrill.svg"', 3: '"neteller.svg"', 5: '"CreditCardVias.svg"', 6: '"Giropay.svg"', 7: '"przelewy-24.svg"', 8: '"rapid-transfer.svg"', 9: '"Nordea.svg"', 10: '"Klarna.svg"', 11: '"wallet.svg"' },
    fiatAllowCountries:[
        '"Australia"','"AU"',
        '"Austria"','"AT"',
        '"Belgium"','"BE"',
    ...
    depositBankListDetail : [
        {'"region"' : '"Moneynetint"', '"IBAN"': '"DE03700111106060006529"', '"account_number"': '"6060006529"', '"account_holder_name"': '"Charlgate Ltd-Deposits Account"', '"Bank_Name"': '"Deutsche HandelsBank"', '"address"': '"Elsenheimerstr. 41, 80687 Munich, Germany"', '"SWIFT"': '"DEKTDE7GXXX"'}
    ],
    
    depositMethod : {1 : '"Bank"' ,2 :'"Skrill"', 3 : '"Neteller"',4 : '"-"', 5: '"Credit Card"'}, 
    depositLink : '"https://dev.finvasia.com:8083/deposit"',
    currencyIcon :{'"EUR"' : '"€"','"USD"' : '"$"','"GBP"' : '"£"','"CHF"' : '"CHF"','"JPY"' : '"¥"','"AUD"': '"$"'},
    ...
    Symbols: {'ALGO':'"ALGO"','BTC':'"BTC"','BCH':'"BCH"','BTG':'"BTG"','BSV':'"BSV"','CELO':'"CELO"','ETH':'"ETH"','ETC':'"ETC"','EOS':'"EOS"','LTC':'"LTC"','RMG':'"RMG"','TRX':'"TRX"','XLM':'"XLM"','MNS':'"ETH"','ACXT':'"ETH"','AQT':'"ETH"','GHUB':'"ETH"','LYN':'"ETH"','UAIR':'"ETH"','UNI':'"ETH"','ACE':'"ETH"','CUSD':'"ETH"','AE':'"ETH"','AERGO':'"ETH"','1UP':'"ETH"','ABT':'"ETH"','AGWD':'"ETH"','AION':'"ETH"','AMN':'"ETH"','AMO':'"ETH"','AMP':'"ETH"','AMON':'"ETH"','AMPX':'"ETH"','ANA':'"ETH"','ANT':'"ETH"','AOA':'"ETH"','APPC':'"ETH"','ARCT':'"ETH"','AST':'"ETH"','AUDIO':'"ETH"','AUDX':'"ETH"','AXPR':'"ETH"','BAL':'"ETH"','BAND':'"ETH"','BASIC':'"ETH"','BAT':'"ETH"','BAX':'"ETH"','BBX':'"ETH"','BCAP':'"ETH"','BCIO':'"ETH"','BEPRO':'"ETH"','BID':'"ETH"','BIDL':'"ETH"','BIRD':'"ETH"','BNK':'"ETH"','BNL':'"ETH"','BNT':'"ETH"','BNTY':'"ETH"','BOX':'"ETH"','BRZ':'"ETH"','BSX':'"ETH"','BTT':'"ETH"','BTU':'"ETH"','BRD':'"ETH"','BUSD':'"ETH"','BUY':'"ETH"','C8P':'"ETH
','TRYB':'"ETH"','TRYX':'"ETH"','TUSD':'"ETH"','UCO':'"ETH"','UKG':'"ETH"','UMA':'"ETH"','UP':'"ETH"','UPBTC':'"ETH"','UPP':'"ETH"','UPT':'"ETH"','UPUSD':'"ETH"','UQC':'"ETH"','URHD':'"ETH"','USDC':'"ETH"','USDT':'"ETH"','USDX':'"ETH"','USG':'"ETH"','USPX':'"ETH"','UST':'"ETH"','USX':'"ETH"','UTK':'"ETH"','UTK1':'"ETH"','VALOR':'"ETH"','VDX':'"ETH"','VRGX':'"ETH"','VXC':'"ETH"','WAFL':'"ETH"','WAX':'"ETH"','WABI':'"ETH"','WBTC':'"ETH"','WET':'"ETH"','WHT':'"ETH"','WPX':'"ETH"','WTC':'"ETH"','XBGOLD':'"ETH"','XCD':'"ETH"','XEX':'"ETH"','XRL':'"ETH"','XSGD':'"ETH"','XTP':'"ETH"','YFI':'"ETH"','YFII':'"ETH"','YLD':'"ETH"','YNG':'"ETH"','YSEY':'"ETH"','ZARX':'"ETH"','ZCO':'"ETH"','ZIL':'"ETH"','ZIX':'"ETH"','ZMT':'"ETH"','ZOOM':'"ETH"','ZRX':'"ETH"'},
    ...
    walletCurrencyList : [
        ...
        { currency_name : '"eToro Australian Dollar "', symbol : '"AUDX"', keyType : '"ERC20"'},
        ...
        { currency_name : '"Basic Attention Token "', symbol : '"BAT"', keyType : '"ERC20"'},
        ...
        { currency_name : '"Brazilian Digital Token "', symbol : '"BRZ"', keyType : '"ERC20"'},
        { currency_name : '"Bistox Exchange Token "', symbol : '"BSX"', keyType : '"ERC20"'},
        ...
        { currency_name : '"eToro Canadian Dollar "', symbol : '"CADX"', keyType : '"ERC20"'},
        ...
        { currency_name : '"eToro Pound Sterling "', symbol : '"GBPX"', keyType : '"ERC20"'},
        ...
        { currency_name : '"eToro Hong Kong Dollar "', symbol : '"HKDX"', keyType : '"ERC20"'},
        ...
        { currency_name : '"InternationalCryptoX "', symbol : '"INCX"', keyType : '"ERC20"'},
        ...
        { currency_name : '"eToro New Zealand Dollar "', symbol : '"NZDX"', keyType : '"ERC20"'},
        ...
        { currency_name : '"PegBitcoin Cash Token "', symbol : '"PBCH"', keyType : '"ERC20"'},
        ...
        { currency_name : '"eToro Singapore Dollar "', symbol : '"SGDX"', keyType : '"ERC20"'},
		...
		{ currency_name : '"Unicorn AIR Security Token"', symbol : '"UAIR"', keyType : '"ERC20"'},
        ...
        { currency_name : '"Universal Protocol Token "', symbol : '"UPT"', keyType : '"ERC20"'},
        { currency_name : '"Universal US Dollar "', symbol : '"UPUSD"', keyType : '"ERC20"'},
        { currency_name : '"Uquid Coin "', symbol : '"UQC"', keyType : '"ERC20"'},
        { currency_name : '"Unicorn Tokenization Robinhood Shares "', symbol : '"URHD"', keyType : '"ERC20"'},
        { currency_name : '"USD Coin "', symbol : '"USDC"', keyType : '"ERC20"'},
        
        { currency_name : '"eToro United States Dollar "', symbol : '"USDX"', keyType : '"ERC20"'},
        ...
        { currency_name : '"Worldwide Asset eXchange "', symbol : '"WAX"', keyType : '"ERC20"'},
