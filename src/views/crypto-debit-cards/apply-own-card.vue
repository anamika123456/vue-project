    ...
    <div class="addCards bg-white round-sm border apply mh-calc">
      ...
      <form class="">
        <div class="d-flex align-items-start justify-content-between flex-wrap select-card-type mb-4 py-3"
          ...
          <RouterLink v-if="cardType == 'team'" class="cap_btn large_btn mt-1" to="/send-invite">Invite User
          </RouterLink>
        </div>
          ...
          <div class="row">
            <div class="col-md-6 col-lg-6">
              <div class="form-group">
                ...
                <input type="text" placeholder="Enter first name" class="form-control" v-model="fname"
                  :disabled='disabled'>
              </div>
            </div>
            <div class="col-md-6 col-lg-6">
              <div class="form-group">
                ...
                <input type="text" placeholder="Enter last name" class="form-control" v-model="lname"
                  :disabled='disabled'>
              </div>
            </div>
            ...
            <div class="col-md-6 col-lg-6">
              <div class="form-group">
                ...
                <div class="verifybtn-wrap phnWrap">
                  ...
                  <vue-tel-input @input="onInput" :value="phno" mode="international" :class="form-control"
                    :placeholder="parsedPlaceholder" :maxlength="10"></vue-tel-input>
                    <span v-if="!isValidPhoneNumber" class="text-danger">Phone number must be 10 digits long.</span>
                  <!-- <button class="verifybtn btn">Verify</button> -->
                  <!-- <span class="green verifybtn text-decoration-none">Verified</span> -->
                </div>
              </div>
        ...
        <input type="button" value="Confirm" class="cap_btn large_btn mt-1 fixBtn" @click="createCarduserFunc()" :disabled="!isValidPhoneNumber" />
      </form>
    </div>
  </div>
  ...
  methods: {
    onInput(phone, phoneObject, input) {
      ...
      if (phoneObject?.formatted) {
        ...
        this.isValidPhoneNumber = this.validatePhoneNumber(phoneObject?.nationalNumber);
      }
    },
    validatePhoneNumber(value) {
      // Only validate if the value is a valid phone number
