<template>
  <div class="mid_scroll_content">
    <div class="pageContent border-0">
      <div class="p-4 bg-white round-sm position-relative border">
...
<script>
  ...
  import webhookList from "../settings/files/developer_api/webhook/list.vue";
  import apiKeyList from "../settings/files/developer_api/api_key/list.vue";
  export default {
    name: "accountprofile",
